...
// Fetch medical records for this doctor (patients only)
$stmt = $pdo->prepare("SELECT m.*, u.full_name AS patient_name
    FROM medicalrecords m
    JOIN patients p ON m.patient_id = p.patient_id
    JOIN users u ON p.user_id = u.user_id
    WHERE m.doctor_id = ? AND u.role = 'Patient'");
...
<head>
    <meta charset="UTF-8">
    <title>Medical Records | Doctor Panel</title>
...
<div class="main-content">
    <div class="record-header">
        ...
        <a href="add-medical-record.php" class="add-button">+ Add New Record</a>
    </div>
        ...
        <?php if ($records): ?>
            <?php foreach ($records as $record): ?>
                <tr>
                    ...
                    <td><a class="btn-edit" href="edit-record.php?id=<?= $record['record_id'] ?>">Edit</a></td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
